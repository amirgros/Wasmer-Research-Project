...
#!/bin/bash
# Usage: ./wasmer_flame.sh <file.wasm> [args...]
...
# The critical change: Wrap the file in the Wasmer CLI with the profiler enabled
WASMER_CMD="wasmer run --profiler=perfmap $WASM_FILE $WASM_ARGS"

echo "-------------------------------------------------------"
echo "Target: $WASMER_CMD"
...
perf record -o "$GRAPH_DIR/perf.data" -e cycles -C 1 -g -- numactl -C 1 -l $WASMER_CMD

# Phase 2: Process Data
# perf script will automatically look for /tmp/perf-<PID>.map generated by Wasmer
